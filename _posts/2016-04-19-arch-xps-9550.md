...
- [ ] persistent touchpad settings: tab to click, so-called natural scrolling, https://wiki.archlinux.org/index.php/Libinput
- [ ] touchpad gesture: two finger back is quite useful in browser
