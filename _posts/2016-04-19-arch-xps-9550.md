...
- [Archlinux on Dell XPS 15 9550](#archlinux-on-dell-xps-15-9550)
  ...
  - [System Configuration](#system-configuration)
    ...
    - [zsh](#zsh)
    - [Touchpad, tap as click and natrual stroll](#touchpad-tap-as-click-and-natrual-stroll)
    - [rofi](#rofi)
    - [Powertop](#powertop)
    - [Fonts](#fonts)
    - [HiDpi](#hidpi)
  ...
  - [Optional Configuration](#optional-configuration)
    ...
    - [Full encrypt exisitng system](#full-encrypt-exisitng-system)
      - [Prepare](#prepare-1)
...
- AdminCD is better than minimal installtion ISO, remember to install NetworkManager in it, or you'll have to tolerate beep sound twice
...
Here `wpa-supplicant` is installed because NetworkManager will control wpa-supplicant when needed,
...
$mod+l is already taken by change focus of i3wm, to make everthing consistent:
...
Setup input metehod follow README of [this repo](https://github.com/ahxxm/rime_config).
...
### Full encrypt exisitng system

It's strongly recommended to setup luks during partitioning, however I forgot to do that.

The [disadvantage](https://wiki.archlinux.org/index.php/Dm-crypt/Encrypting_an_entire_system#Simple_partition_layout_with_LUKS) of this encrypting strategy is: you can't easity backup used space.
...
- [ ] eliminate crack/pop-up sound when switch song inside [musicbox](https://github.com/darknessomi/musicbox) with headphone plugin
