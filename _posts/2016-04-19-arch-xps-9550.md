...
- [ ] necessary dkms package: bbswitch? seems no need...
- [ ] fn key: PrtScr and keyboard light works out of box, others don't https://wiki.archlinux.org/index.php/Extra_keyboard_keys (.. and seems they are the only keys I'd use? nope.. sound adjust is also useful)
